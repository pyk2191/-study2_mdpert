...
const SignUpCompany = props => {
  ...
  const handleSignUp = event => {
    ...
    axios.post('http://127.0.0.1:7070/starj-frame-demo/api/jwt/portal/app-data/mps/user/create', {
      "NAME"          : formState.values.name,
      "EMAIL"         : formState.values.email,
      "PASSWORD"      : formState.values.password,
      "PHONE"         : formState.values.phoneNumber,
      "OWNER"         : formState.values.companyName,
      "DETAILS"       : formState.values.othersContent,
      "TYPE"          : "UTYCSN"
    },{
      headers: {
          ...
          <div className={classes.content}>
            ...
            <div className={classes.contentBody}>
              ...
              >
                ...
                <TextField
                  className={classes.textField}
                  error={hasError('othersContent')}
                  fullWidth
                  multiline
                  rows={4} 
                  helperText={
                    hasError('othersContent') ? formState.errors.othersContent[0] : null
                  }
                  label="기타 내용"
                  name="othersContent"
                  onChange={handleChange}
                  type="text"
                  value={formState.values.othersContent || ''}
                  variant="outlined"
                />
                <Button
